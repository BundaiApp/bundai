...
export const SmallBlock = ({ handlePress, blockHeader, sub }) => (
	<TouchableOpacity style={[styles.jlptBlock, { backgroundColor: whichColor[blockHeader] }]} onPress={handlePress}>
...
export const Pill = ({ index, handlePress, subject, level, isAll }) => (
	<TouchableOpacity
		style={[styles.pill, { backgroundColor: whichColor[isAll ? 'Adverbs' : subject] }]}
		onPress={handlePress}>
